...
<body>
    ...
    <section class="home" id="home">
        <div class="home-content">
            <h1>We Are <span class="element">Web </span></h1>
            <div class="social">
            ...
            <div class="row">
                ...
                <div class="col-md-6 about-text wow fadeInUp" data-wow-delay="0.8s">
                    <div class="out">
                        ...
                        <br/>
                        <p>
                            Impossible considered invitation him men instrument saw celebrated unpleasant. Put rest and must set kind next many near nay. He exquisite continued explained middleton am. Voice hours young woody has she think equal. Estate moment he at on wonder at
                            season little. Six garden result summer set family esteem nay estate.
                            <br/><br/> Her extensive perceived may any sincerity extremity. Indeed add rather may pretty see. Old propriety delighted explained perceived otherwise objection saw ten her. Doubt merit sir the right these alone keeps. By
                            sometimes intention smallness he northward.
                        </p>
                    </div>
                </div>
            </div>
        ...
        <div class="container-fluid gray-bg">
            <div class="container what-can">
                ...
                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12 feature">
                    ...
                    <h3>HP制作</h3>
                    <p>お客様の事業に合ったHPのデザインを提案させていただきます。</p>
                </div>
                <!-- Graphic Design -->
                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12 feature">
                    <i data-icon="C" class="icon"></i>
                    <h3>写真撮影</h3>
                    <p>5000円/時間で対応可能です。（交通費別） </p>
                </div>
                <!-- Graphic Design -->
                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12 feature">
                    <i data-icon="U" class="icon"></i>
                    <h3>動画編集</h3>
                    <p>Youtubeに投稿する動画からPR動画まで幅広く対応可能です。 </p>
                </div>
                <!-- Graphic Design -->
                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12 feature">
                    <i data-icon="P" class="icon"></i>
                    <h3>ライティング</h3>
                    <p>商品・サービスのレビュー記事を当社ブログにて宣伝させていただきます。</p>
                </div>
            </div>
        </div>
    </section>
    <section class="pricing-area pt-100 pb-70">
        <div class="container">
            <div class="section-title">
                <h2>Price</h2>
                <div class="bar"></div>
                <p>当社では 「シンプルプラン」「ベーシックプラン」「プレミアムプラン」の3つの制作プランがあります。<br> お客様のビジネスモデルに合ったプランをご提案させて頂きます。<br> ※既存のサイトが他社様からの引き継ぎの場合、契約内容等によっては、別途33,000円【税込】〜頂戴する場合がございます。
                </p>
            </div>
                        ...
                        <div class="row">
                            <div class="col-lg-4 col-md-6">
                                <div class="single-pricing-table">
                                    ...
                                    <div class="price">
                                        <sup>220,000円 <sub>（税込）</sub>
                                    </div>
                                    <ul class="pricing-features">
                                        <li>
                                            <i class="fa fa-check"></i> 管理費(プランからお選び頂きます):月々8,800円【税込】～
                                        </li>
                                        <li>
                                            <i class="fa fa-check"></i> 画像・テキスト差し替え：プランによって異なります
                                        </li>
                                        <li>
                                            <i class="fa fa-check"></i> 画像編集・追加(1ヶ所)：サイズ、編集ヶ所によって異なります
                                        </li>
                                        <li>
                                            <i class="fa fa-check"></i> 素材撮影費用：5,500円/１時間
                                        </li>
                                        <li>
                                            <i class="fa fa-check"></i>スマホサイト対応済み/SSL化対応

                                        </li>
                                        <li>
                                            <i class="fa fa-check"></i> トップページも含め5ページ作成
                                        </li>
                                        <li>
                                            <i class="fa fa-check"></i> ブログ・お知らせ機能追加可
                                        </li>
                                        <li>
                                            <i class="fa fa-check"></i> 問い合わせフォーム追加可
                            ...
                            <div class="col-lg-4 col-md-6">
                                <div class="single-pricing-table">
                                    ...
                                    <ul class="pricing-features">
                                        ...
                                        <li>
                                            <i class="fa fa-check"></i> トップページも含め7ページ作成
                                        </li>
                                        <li>
                                            <i class="fa fa-check"></i>ブログ・お知らせ機能追加可
                                        </li>
                                        <li>
                                            <i class="fa fa-check"></i> 更新型コンテンツ2ページ可
                                        </li>
                                        <li>
                                            <i class="fa fa-check"></i> 問い合わせフォーム追加可
                                        </li>
                            ...
                            <div class="col-lg-4 col-md-6">
                                <div class="single-pricing-table">
                                    ...
                                    <div class="price">
                                        <sup>550,000円 <sub>（税込）</sub>
                                    </div>
                                    <ul class="pricing-features">
                                        <li>
                                            <i class="fa fa-check"></i> 管理費(プランからお選び頂きます):月々8,800円～
                                        </li>
                                        <li>
                                            <i class="fa fa-check"></i> 画像・テキスト差し替え：プランによって異なります
                                        </li>
                                        ...
                                        <li>
                                            <i class="fa fa-check"></i> スマホサイト対応済み
                                        </li>
                                        <li>
                                            <i class="fa fa-check"></i> SSL化対応
                                        </li>
                                        <li>
                                            <i class="fa fa-check"></i> ページ数、機能等は要ご相談
                                        </li>
                                        <li>
                                            <i class="fa fa-check"></i>ブログ・お知らせ機能追加可
                                        </li>
    ...
    <section class="contact" id="contact">
        <div class="container">
            <div class="section-title">
                <h2>CONTACT</h2>
                <p class="contact-message">私たちは、まず地元を盛り上げたいと思いこのサイト・会社を立ち上げました。 <br/> ただ、地元に限らず周りを巻き込んで良いものを創りたいという思いがあるので <br/>お手伝いできることがあればご相談ください </p>
            </div>
            <!-- Contact Info -->
            <div class="row">
                ...
                <div class="col-md-8 col-md-offset-2 wow fadeInUp" data-wow-delay="1s">
                    <form class="col-md-12 contact-form" method="POST" action="mail.php">
                        <div class="row">
                            <!--Name-->
                            <div class="col-md-6">
                                <input id="con_name" name="con_name" class="form-inp requie" type="text" placeholder="お名前/Name">
                            </div>
                            <!--Email-->
                            <div class="col-md-6">
                                <input id="con_email" name="con_email" class="form-inp requie" type="text" placeholder="メールアドレス/Email">
                            </div>
                            <div class="col-md-12">
                                <!--Message-->
                                <textarea name="con_message" id="con_message" class="requie" placeholder="メッセージ/Message" rows="8"></textarea>
